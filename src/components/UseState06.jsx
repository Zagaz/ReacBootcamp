  ...
  return (
    <>
      <div className="wrap">
        ...
        <p>
          <strong>Hypotenuse : </strong> {h}{" "}
        </p>
        <p>
          <strong>Sine : </strong> {sin}
        </p>
        <p>
          <strong>Cosine : </strong> {cos}
        </p>
        <p>
          <strong>Arcsine : </strong> {arcsine} deg{" "}
        </p>
        <p>
          <strong>Arccosine:</strong> {arccosine} deg{" "}
        </p>
      </div>
      ...
      <div className="wrap">
        ...
        <div className="catetus">
          <h3>
            {" "}
            Cathetus B : <strong>{b} </strong>{" "}
          </h3>
          <div className="catetusbt">
            <Cathetus description="-" calc={subB} style="btn red" />
            <Cathetus description="+" calc={addB} style="btn blue" />
          </div>
        </div>
        <div className="resetwrap">
          <Cathetus description="RESET" calc={reset} style="btn reset" />
        </div>
      </div>
